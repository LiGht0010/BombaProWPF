...
public partial class DepotCaisseEditPopup : Popup
{
    ...
    public DepotCaisseEditPopup(DepotCaisseDto depot)
    {
        InitializeComponent();
        ...
        SubtitleLabel.Text = $"Depot du {depot.DateDepot:dd/MM/yyyy}";
