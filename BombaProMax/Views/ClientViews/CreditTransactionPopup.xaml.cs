...
public partial class CreditTransactionPopup : Popup
{
        ...
        string? generatedNumero = null)
    {
        ...
        {
            HeaderLabel.Text = "?? Modifier Transaction Crédit";
    ...
    private void PopulateForEdit(CreditTransactionDto transaction)
    {
        ...
        QuantiteEntry.Text = transaction.Quantite.ToString();
    ...
    {
        if (int.TryParse(QuantiteEntry.Text, out int quantite) &&
    ...
    private void OnSaveClicked(object? sender, EventArgs e)
    {
        ...
        transaction.Quantite = int.Parse(QuantiteEntry.Text);
