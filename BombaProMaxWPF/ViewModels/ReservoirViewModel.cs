...
public partial class ReservoirViewModel : ObservableObject
{
    ...
    private async Task ShowOpeningBalanceAsync()
    {
        try
        {
            ...
            // TODO: Show WPF Opening Balance dialog when views are created
            await _dialogService.ShowAlertAsync("Stock Initial",
                "La configuration du stock initial sera disponible dans la prochaine version de l'interface WPF.");
