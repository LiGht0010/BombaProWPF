...
public class EditPaiementFournisseurViewModel : ObservableObject
{
    ...
    private readonly int       _pendingCreditFournisseurId;
    ...
    public EditPaiementFournisseurViewModel(PaiementFournisseurDto dto)
    {
        _paiementId                 = dto.PaiementFournisseurId;
        _originalAjoutePar          = dto.AjoutePar;
        _originalDateCreation       = dto.DateCreation;
        _pendingCreditFournisseurId = dto.CreditFournisseurId;
    ...
    public async Task LoadLookupsAsync()
    {
        ...
        try
        {
            ...
            SelectedCredit = Credits.FirstOrDefault(c => c.CreditFournisseurId == _pendingCreditFournisseurId);
        ...
        {
            Debug.WriteLine($"[EditPaiementFournisseurVM] LoadLookups error: {ex.Message}");
            ErrorMessage = LanguageManager.Instance["EditPfLoadError"];
        }
    }
    ...
    private async Task SaveAsync()
    {
        ...
        {
            ErrorMessage = LanguageManager.Instance["EditPfValidationCredit"];
            return;
        }
        if (Montant is null or <= 0)
        {
            ErrorMessage = LanguageManager.Instance["EditPfValidationMontant"];
            return;
        }
        ...
        try
        {
            ...
            {
                PaiementFournisseurId = _paiementId,
            ...
            if (ok)
                ...
                ErrorMessage = LanguageManager.Instance["EditPfSaveError"];
        }
