...
public partial class NouveauPaiementFournisseurDialog : FluentWindow
{
    public NouveauPaiementFournisseurViewModel ViewModel { get; }

    public NouveauPaiementFournisseurDialog()
    {
        InitializeComponent();
        ViewModel   = new NouveauPaiementFournisseurViewModel();
