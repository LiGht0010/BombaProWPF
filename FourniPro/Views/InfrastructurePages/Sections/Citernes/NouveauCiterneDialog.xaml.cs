...
public partial class NouveauCiterneDialog : FluentWindow
{
    public NouveauCiterneViewModel ViewModel { get; }

    public NouveauCiterneDialog()
    {
        InitializeComponent();
        ViewModel   = new NouveauCiterneViewModel();
