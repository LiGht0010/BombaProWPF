...
public partial class EditChauffeurDialog : FluentWindow
{
    public EditChauffeurViewModel ViewModel { get; }

    public EditChauffeurDialog(ChauffeurDto dto)
    {
        InitializeComponent();
        ViewModel   = new EditChauffeurViewModel(dto);
