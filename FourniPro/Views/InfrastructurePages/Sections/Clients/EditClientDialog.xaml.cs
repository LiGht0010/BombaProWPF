...
public partial class EditClientDialog : FluentWindow
{
    public EditClientViewModel ViewModel { get; }

    public EditClientDialog(ClientDto dto)
    {
        InitializeComponent();
        ViewModel   = new EditClientViewModel(dto);
