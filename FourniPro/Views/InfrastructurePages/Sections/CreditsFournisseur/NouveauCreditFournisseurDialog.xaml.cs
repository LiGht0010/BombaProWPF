...
public partial class NouveauCreditFournisseurDialog : FluentWindow
{
    public NouveauCreditFournisseurViewModel ViewModel { get; }

    public NouveauCreditFournisseurDialog()
    {
        InitializeComponent();
        ViewModel   = new NouveauCreditFournisseurViewModel();
