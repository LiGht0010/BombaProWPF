...
public partial class EditEmployeDialog : FluentWindow
{
    public EditEmployeViewModel ViewModel { get; }

    public EditEmployeDialog(EmployeDto dto)
    {
        InitializeComponent();
        ViewModel   = new EditEmployeViewModel(dto);
