...
public partial class EditCreditDialog : FluentWindow
{
    public EditCreditViewModel ViewModel { get; }

    public EditCreditDialog(CreditDto credit)
    {
        InitializeComponent();
        ViewModel   = new EditCreditViewModel(credit);
